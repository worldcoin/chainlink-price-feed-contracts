...
contract DeployProduction is Script {
    function run() external {
        ...
        pairName = "WLD/USD";
        deployPriceFeed(pairAddress, usdcAddress, verifierProxyAddress, feedId, pairName);
    ...
    {
        vm.startBroadcast();
        new ChainlinkPriceFeed(pairAddress, usdcAddress, verifierProxyAddress, feedId, pairName);
        vm.stopBroadcast();
    }
}
